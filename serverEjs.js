...
io.on('connection', function(socketProducto) {
    socketProducto.emit("producto", producto); // Enviamos los productos al cliente

    socketProducto.on('new-producto', function(data) {
